...
return [
    ...
    */
    ...
    | that Pulse is accessible at the root of the subdomain.
    |
    */

    'path' => env('PULSE_PATH', $pulseDomain !== null ? '' : 'pulse'),
    ...
    */
    ...
    'storage' => [
        ...
        'trim' => [
            'keep' => env('PULSE_STORAGE_KEEP', '3 days'), // Reduced for small server
        ],
    ...
    */
    ...
    'ingest' => [
        ...
        'trim' => [
            'lottery' => [1, 1_000],
            'keep' => env('PULSE_INGEST_KEEP', '3 days'), // Reduced for small server
        ],
    ...
    */
    ...
    'recorders' => [
        Recorders\CacheInteractions::class => [
            ...
            'sample_rate' => env('PULSE_CACHE_INTERACTIONS_SAMPLE_RATE', 0.1), // 10% sampling for lightweight
            'ignore' => [
        ...
        Recorders\Exceptions::class => [
            ...
            'sample_rate' => env('PULSE_EXCEPTIONS_SAMPLE_RATE', 0.5), // 50% sampling for lightweight
        ...
        Recorders\Queues::class => [
            ...
            'sample_rate' => env('PULSE_QUEUES_SAMPLE_RATE', 0.2), // 20% sampling for lightweight
            'ignore' => [
                // '/^Package\\\\Jobs\\\\/',
            ],
        ],
        ...
        Recorders\SlowJobs::class => [
            ...
            'sample_rate' => env('PULSE_SLOW_JOBS_SAMPLE_RATE', 0.3), // 30% sampling for lightweight
        ...
        Recorders\SlowOutgoingRequests::class => [
            ...
            'sample_rate' => env('PULSE_SLOW_OUTGOING_REQUESTS_SAMPLE_RATE', 0.2), // 20% sampling for lightweight
        ...
        Recorders\SlowQueries::class => [
            ...
            'sample_rate' => env('PULSE_SLOW_QUERIES_SAMPLE_RATE', 0.3), // 30% sampling for lightweight
        ...
        Recorders\SlowRequests::class => [
            ...
            'sample_rate' => env('PULSE_SLOW_REQUESTS_SAMPLE_RATE', 0.2), // 20% sampling for lightweight
            'threshold' => env('PULSE_SLOW_REQUESTS_THRESHOLD', 1000),
            'ignore' => [
                '#^/'.($pulseDomain !== null ? '' : env('PULSE_PATH', 'pulse')).'$#', // Pulse dashboard...
        ...
        Recorders\UserJobs::class => [
            ...
            'sample_rate' => env('PULSE_USER_JOBS_SAMPLE_RATE', 0.2), // 20% sampling for lightweight
            'ignore' => [
                // '/^Package\\\\Jobs\\\\/',
            ],
        ],
        ...
        Recorders\UserRequests::class => [
            ...
            'sample_rate' => env('PULSE_USER_REQUESTS_SAMPLE_RATE', 0.2), // 20% sampling for lightweight
            'ignore' => [
                '#^/'.($pulseDomain !== null ? '' : env('PULSE_PATH', 'pulse')).'$#', // Pulse dashboard...
                '#^/telescope#', // Telescope dashboard...
                '#^/horizon#', // Horizon dashboard...
