...
<body class="bg-gray-50 font-sans antialiased dark:bg-gray-950">
	<div class="min-h-screen">
		<header class="px-5">
			<div class="{{ $fullWidth ? '' : 'container' }} mx-auto border-b border-gray-200 py-3 sm:py-5 dark:border-gray-900">
				<div class="flex items-center justify-between">
					<div class="flex items-center">
						...
						<span class="ml-2 text-lg font-medium text-gray-700 sm:text-2xl dark:text-gray-300"><b class="font-bold">Laravel</b> Pulse</span>
					</div>
					<div class="flex items-center gap-3 sm:gap-6">
						<a class="inline-flex items-center justify-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800" href="{{ config('app.url') }}" title="Go to Home">
