    ...
    <div class="@if ($this->getColumnSelectIsHiddenOnMobile()) hidden sm:block @elseif ($this->getColumnSelectIsHiddenOnTablet()) hidden md:block @endif mb-4 w-full md:w-auto md:mb-0 md:ml-2">
        ...
        >
                ...
                <span class="rounded-md shadow-sm">
                    <button
                        ...
                        {{
                            ...
                            ->class([
                                'inline-flex justify-center px-4 py-2 w-full text-sm font-medium rounded-md shadow-sm focus:ring focus:ring-opacity-50' => $this->getColumnSelectButtonAttributes()['default-styling'],
            ...
            <div
                ...
                class="absolute right-0 z-50 mt-2 w-full rounded-md divide-y divide-neutral-100 dark:divide-zinc-700 ring-1 ring-black ring-opacity-5 shadow-lg origin-top-right md:w-48 focus:outline-none"
            >
                <div class="bg-white rounded-md shadow-xs dark:bg-zinc-900 dark:text-zinc-100">
