...
<body>
	<div id="horizon" v-cloak>
		...
		<div class="container mb-5">
			<div class="d-flex align-items-center header py-4">
				...
				<a class="btn btn-muted d-flex align-items-center ms-3 py-2" href="{{ config('app.url') }}" title="Go to Home">
				...
				<div class="ms-auto">
					...
					<button class="btn btn-muted ms-2" title="Auto Load New Entries" :class="{ active: autoLoadsNewEntries }" v-on:click.prevent="autoLoadNewEntries">
						<svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
			...
			<div class="row mt-4">
				<div class="col-2 sidebar">
					<ul class="nav flex-column">
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/dashboard">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/monitoring">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/metrics">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/jobs/pending">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/jobs/completed">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/jobs/silenced">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/failed">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
