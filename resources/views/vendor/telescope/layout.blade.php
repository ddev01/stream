...
<body>
	<div id="telescope" v-cloak>
		...
		<div class="container mb-5">
			<div class="d-flex align-items-stretch header py-4">
				...
				<a class="btn btn-muted d-flex align-items-center ml-2 mr-3 py-2" href="{{ config('app.url') }}" title="Go to Home">
				...
				<button class="btn btn-muted d-flex align-items-center ml-auto mr-3 py-2" v-on:click.prevent="toggleRecording" :title="recording ? 'Pause recording' : 'Resume recording'">
					<svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" v-if="recording">
						<path d="M5.75 3a.75.75 0 00-.75.75v12.5c0 .414.336.75.75.75h1.5a.75.75 0 00.75-.75V3.75A.75.75 0 007.25 3h-1.5zM12.75 3a.75.75 0 00-.75.75v12.5c0 .414.336.75.75.75h1.5a.75.75 0 00.75-.75V3.75a.75.75 0 00-.75-.75h-1.5z" />
					</svg>
					<svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" v-else>
						<path d="M6.3 2.841A1.5 1.5 0 004 4.11V15.89a1.5 1.5 0 002.3 1.269l9.344-5.89a1.5 1.5 0 000-2.538L6.3 2.84z" />
					</svg>
				</button>

				<button class="btn btn-muted d-flex align-items-center mr-3 py-2" title="Clear entries" v-on:click.prevent="clearEntries">
					<svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
						<path fill-rule="evenodd" d="M8.75 1A2.75 2.75 0 006 3.75v.443c-.795.077-1.584.176-2.365.298a.75.75 0 10.23 1.482l.149-.022.841 10.518A2.75 2.75 0 007.596 19h4.807a2.75 2.75 0 002.742-2.53l.841-10.52.149.023a.75.75 0 00.23-1.482A41.03 41.03 0 0014 4.193V3.75A2.75 2.75 0 0011.25 1h-2.5zM10 4c.84 0 1.673.025 2.5.075V3.75c0-.69-.56-1.25-1.25-1.25h-2.5c-.69 0-1.25.56-1.25 1.25v.325C8.327 4.025 9.16 4 10 4zM8.58 7.72a.75.75 0 00-1.5.06l.3 7.5a.75.75 0 101.5-.06l-.3-7.5zm4.34.06a.75.75 0 10-1.5-.06l-.3 7.5a.75.75 0 101.5.06l.3-7.5z" clip-rule="evenodd" />
					</svg>
				</button>

				<button class="btn btn-muted d-flex align-items-center mr-3 py-2" title="Auto load entries" :class="{ active: autoLoadsNewEntries }" v-on:click.prevent="autoLoadNewEntries">
					<svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
			...
			<div class="row mt-4">
				<div class="col-2 sidebar">
					<ul class="nav flex-column">
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/requests">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/commands">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/schedule">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/jobs">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item mt-3">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/batches">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/cache">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/dumps">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/events">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/exceptions">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/gates">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/client-requests">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/logs">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/mail">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/models">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/notifications">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/queries">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/redis">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						...
						<li class="nav-item">
							<router-link class="nav-link d-flex align-items-center" active-class="active" to="/views">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
